...
遊びたいファイル（①または②）を開き、
右上の「…」→ **Download** を選択して保存してください。

※ダウンロードできない場合は、ファイルを開いて内容をすべてコピーし、そのままAIへ貼り付けても遊べます。

---

1. お使いのAIを開きます。
2. 次のいずれかのファイルを読み込ませます。
   - ① ChatGPTで遊ぶ水平思考クイズ.md（ChatGPT向け）
   - ② AIで遊ぶ水平思考クイズ.md（Claude・Geminiなど）
3. AIが作品一覧を表示します。
4. 好きな作品を選んで遊んでください。

1.  お使いのAIを開きます。
2.  プレイするAIに合わせて、次のどちらかのファイルを読み込ませます。※ファイルのダウンロードに対応しているAIなら、そのまま添付して遊べます。
    -   **① ChatGPTで遊ぶ水平思考クイズ.md**（ChatGPT向け）
